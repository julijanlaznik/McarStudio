            ...
            <div className="relative w-full max-w-xl mx-auto lg:ml-auto">
              ...
              >
                ...
                {!submitted ? (
                  <form onSubmit={handleSubmit} className="space-y-6 animate-fade-up">
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className={`group relative w-full py-5 bg-brand text-black text-xs sm:text-sm md:text-base rounded-full transition-all duration-500 shadow-[0_15px_50px_-10px_rgba(254, 5, 52, 0.4)] overflow-hidden active:scale-[0.98] font-unbounded ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                      >
                        <span className="relative z-10 uppercase tracking-[0.15em] font-medium">
                  ...
                  <div className="text-center animate-fade-up py-10">
                    <div className="w-20 h-20 bg-brand rounded-full flex items-center justify-center mx-auto mb-8 shadow-[0_0_40px_rgba(254, 5, 52, 0.4)]">
              ...
              <div className="mt-6 flex flex-col items-center lg:items-end animate-fade-up delay-3">
                ...
                >
                  ...
                  <span className="text-white text-lg md:text-xl font-sans tracking-tight">+420 775 542 333</span>
                </a>
              </div>
            </div>
          </div>
