    ...
    <>
      ...
      <div className="flex justify-end max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-[-20px] relative z-20">
        <motion.button
          ...
          className="bg-brand text-black px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 font-unbounded text-sm md:text-base -rotate-3 hover:rotate-0 transition-all duration-300 border-2 border-black/5"
        >
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white">
                ...
                <button
                  onClick={handleCta}
                  className="w-full bg-black text-white py-5 rounded-full text-lg hover:bg-brand hover:text-black transition-all duration-300 shadow-xl transform hover:-translate-y-1 font-unbounded"
                >
