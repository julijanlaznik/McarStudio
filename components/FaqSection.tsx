      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {!showAll && faqs.length > initialCount && (
          <div className="mt-12 text-center">
            <button
              ...
              className="px-8 py-4 bg-white border border-gray-200 text-black rounded-full hover:border-brand hover:text-brand transition-all shadow-sm font-unbounded text-xs md:text-sm"
            >
        ...
        <div className="mt-24 bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-xl text-center relative overflow-hidden">
          ...
          <a 
            ...
            className="inline-flex items-center gap-3 md:gap-4 px-6 py-4 md:px-10 md:py-5 bg-black text-white rounded-full hover:bg-brand hover:text-black transition-all duration-300 group shadow-lg font-unbounded"
          >
            <div className="w-8 h-8 md:w-10 md:h-10 bg-white/10 group-hover:bg-black/10 rounded-full flex items-center justify-center transition-colors">
              <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
            </div>
            <span className="text-lg md:text-2xl tracking-tight whitespace-nowrap">+420 775 542 333</span>
          </a>
        </div>
      </div>
    </section>
