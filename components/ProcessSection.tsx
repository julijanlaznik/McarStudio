...
const ProcessSection: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white overflow-hidden">
      ...
      >
        <div className="flex gap-6 pr-4 sm:pr-6 lg:pr-8 pl-[calc(max(1rem,50vw-640px+1rem))] sm:pl-[calc(max(1.5rem,50vw-640px+1.5rem))] lg:pl-[calc(max(2rem,50vw-640px+2rem))]">
            ...
            >
              ...
              <div className="relative z-10 p-8 md:p-12 h-full flex flex-col">
                <div className="flex items-center gap-4 mb-8">
                  <span className={`text-xl md:text-2xl font-bold font-unbounded ${step.isLight ? 'text-black' : 'text-white'}`}>
                    {step.number}
                  </span>
