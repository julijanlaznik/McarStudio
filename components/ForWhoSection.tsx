        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-8 mb-14">
              {targetGroups.map((group, index) => (
                ...
                >
                  <div className="absolute left-0 top-1.5 w-1.5 h-1.5 rounded-full bg-[#fe0534] shadow-[0_0_10px_#fe0534]"></div>
            ...
            <div className={`flex flex-col items-start gap-4 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <button
                ...
                className="cta-button-secondary px-8 py-3.5 rounded-full text-sm md:text-base transition-all shadow-sm inline-flex items-center justify-center font-unbounded"
              >
          ...
          <div className={`flex-1 w-full lg:w-auto transition-all duration-[1.5s] ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
            <div className="relative group">
              {/* Decorative elements */}
              <div className="absolute -top-6 -right-6 w-32 h-32 bg-[#fe0534]/10 rounded-full blur-3xl -z-10"></div>
              <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-[#fe0534]/5 rounded-full blur-3xl -z-10"></div>
