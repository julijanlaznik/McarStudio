          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                ...
                <button
                  onClick={handleCta}
                  className="w-full py-4 bg-brand text-black rounded-full hover:shadow-lg hover:scale-[1.02] transition-all duration-300 font-unbounded uppercase tracking-wider text-sm"
                >
